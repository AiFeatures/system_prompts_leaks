...
> Upstream: [asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
...
System prompts research mirror with iAiFy governance metadata only.
...
- `456d0d0 docs: refresh  rename to canonical casing, add standard sectionsREADME (#2)`
- `23a6459 chore: sync CLAUDE.md and copilot-instructions docs`
- `696ef63 ci: add dependabot.yml for iAiFy governance`
- `147a3b3 docs: add AGENTS.md for iAiFy governance`
- `72916e2 docs: add copilot-instructions.md for iAiFy governance`
- `4b4e9b6 docs: add CLAUDE.md for iAiFy governance`
